...
import (
	...
	"github.com/jordanhw34/GoWebStarter/internal/config"
	"github.com/jordanhw34/GoWebStarter/internal/drivers"
	"github.com/jordanhw34/GoWebStarter/internal/forms"
	"github.com/jordanhw34/GoWebStarter/internal/helpers"
	"github.com/jordanhw34/GoWebStarter/internal/models"
	"github.com/jordanhw34/GoWebStarter/internal/render"
	"github.com/jordanhw34/GoWebStarter/internal/repository"
	"github.com/jordanhw34/GoWebStarter/internal/repository/dbrepo"
)
...
func (repo *Repository) AdminReservationsAll(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Println(" > Error in GetAllReservations() Function")
		helpers.ServerError(w, err)
		return
	}
